            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="myinfo.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-2 control-label">人员类型</label>
                            <div class="col-sm-10 ">
                                <select name="type" class="form-control" id="type">
                                    <option <?= !isset($_SESSION['user_type']) ? 'selected' : '' ?> value="0">无</option>
                        ...
                        <div class="form-group">
                            <label for="work" class="col-sm-2 control-label">工作领域</label>
                            <div class="col-sm-10 ">
                                <select name="work" class="form-control" id="work">
                                    <option <?= !isset($_SESSION['area_id']) != null ? 'selected' : '' ?> value="0">无
                                    </option>
                        ...
                        <div class="form-group">
                            <label for="eduction" class="col-sm-2 control-label">学历</label>
                            <div class="col-sm-10 ">
                        ...
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">个人描述</label>
                            <div class="col-sm-10">
